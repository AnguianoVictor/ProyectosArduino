...
void setup()
{
    ...
    digitalWrite(th,HIGH);                                  //Se inicializa el pin de la trampa de humo en alto (1)
    digitalWrite(vitrina,HIGH);                             //Se inicializa el pin de la vitrina de oro en alto (1)
    digitalWrite(sirena,HIGH);                             
    digitalWrite(vitrina_elect,HIGH);                       //Se inicializa el pin de la vitrina de electronicos en alto (1)
    digitalWrite(auditoria,HIGH);
    digitalWrite(mensaje1,HIGH);                             //Se inicializa el pin del primer mensaje en bajo (0)
    digitalWrite(mensaje2,HIGH);                             //Se inicializa el pin del segundo mensaje en bajo (0)
}
/*************************/
void Trampa_HumoOFF()                                       //Funcion para desactivar la trampa de humo
{
  digitalWrite(th,HIGH);                                      //Se escribe en el pin de la trampa de humo en alto (1)
}
void Trampa_HumoON()                                        //Funcion para activar la trampa de humo
{
  digitalWrite(th,LOW);                                       //Se escribe el pin de la trampa de humo en bajo (0)
  delay(700);                                                 //Retardo de 700ms
  digitalWrite(th,HIGH);                                      //Se escribe el pin de la trampa de humo en alto (1)
}
void VitrinaOFF()                                           //Funcion para desactivar la vitrina de oro. 
{
  digitalWrite(vitrina,HIGH);                                 //Se escribe el pin de la vitrina de oro en alto (1) 
}
void VitrinaON()                                            //Funcion para activar la vitrina de oro. 
{
  digitalWrite(vitrina,LOW);                                  //Se escribe el pin de la vitrina de oro en bajo (0)
}
void VitrinaElectOFF()                                      //Funcion para desactivar la vitrina de electronicos.
{
  digitalWrite(vitrina_elect,HIGH);                           //Se escribe el pin de la vitrina de oro en alto (1)
}
void VitrinaElectON()                                       //Funcion para activar vitrina de electronicos
{
  digitalWrite(vitrina_elect,LOW);                            //Se escribe el pin de la vitrina de electronicos en bajo (0)
}
void SirenaOFF()                                            //Funcion para desactivar la sirena
{
  digitalWrite(sirena,HIGH);                                  //Se escribe el pin de la sirena en alto (1)
}
void SirenaON()                                             //Funcion para activar la sirena
{
  digitalWrite(sirena,LOW);                                   //Se escribe el pin de la sirena en bajo (0)
}
void AuditoriaON()
{
...
{
    digitalWrite(th,HIGH);                                    //Se escribe el pin de la trampa de humo en alto (1)
    digitalWrite(vitrina,HIGH);                               //Se escribe el pin de la vitrina en alto (1)
    digitalWrite(sirena,HIGH);                                //Se escribe el pin de la sirena alto (1)
    digitalWrite(vitrina_elect,HIGH);                         //Se escribe el pin de la vitrina de electronicos en alto (1)
}
